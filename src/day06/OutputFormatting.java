...
public class OutputFormatting {
	...
	public static void main(String[] args) {
		...
		The leading digit of the integer is the 16th character, and each integer
		that was less than 3 digits now has leading zeroes.
		System.out.printf("%-15s",variableString);
*/
		Scanner scan = new Scanner(System.in);
		System.out.println("how many items will you enter");
		int numberOfItems = scan.nextInt();
		String arr[]=new String[numberOfItems];
		int arr1[] = new int[numberOfItems];
